...
class Union {
  ...
  [Symbol.peacock_equals](other) {
    ...
    return this.patterns[Symbol.peacock_equals](other.patterns);
  }
  [Symbol.peacock_contains](value) {
    return this.patterns[Symbol.peacock_contains](value);
  }
  [Symbol.iterator]() {
    return this.patterns[Symbol.iterator]();
  }
}
...
s.checkInstance = function checkInstance(PatternClass, value) {
  if (PRIMITIVES.includes(typeof value)) return false;
  if (value) return value.constructor === PatternClass;
};
