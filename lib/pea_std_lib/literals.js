...
class Component {
  ...
  create_style_sheet() {
    if (Component.style_sheet) return Component.style_sheet;
    Component.style_sheet = document.createElement("style");
    document.body.append(Component.style_sheet);
    return Component.style_sheet;
  }
  style() {
    return Str.new("");
  }
  ...
  to_dom() {
    ...
    if (elem instanceof Component) throw new NotReached();
